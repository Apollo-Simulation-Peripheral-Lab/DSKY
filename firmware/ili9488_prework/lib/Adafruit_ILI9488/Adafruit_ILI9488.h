...
#define ILI9488_TFTWIDTH 480  ///< ILI9488 max TFT width
#define ILI9488_TFTHEIGHT 320 ///< ILI9488 max TFT height
...
class Adafruit_ILI9488 : public Adafruit_SPITFT {
public:
  Adafruit_ILI9488(int8_t _CS, int8_t _DC, int8_t _MOSI, int8_t _SCLK,
                   int8_t _RST = -1, int8_t _MISO = -1);
  Adafruit_ILI9488(int8_t _CS, int8_t _DC, int8_t _RST = -1);
#if !defined(ESP8266)
  Adafruit_ILI9488(SPIClass *spiClass, int8_t dc, int8_t cs = -1,
                   int8_t rst = -1);
#endif // end !ESP8266
  Adafruit_ILI9488(tftBusWidth busWidth, int8_t d0, int8_t wr, int8_t dc,
