...
let yaAGCClient;
const parseAGCOutput = (channel, value) => {
    if (channel === 0o13) {
        value &= 0o3000;
    }
    ...
    state = Object.assign({}, state); // Create new state to avoid modifying the propagated state. This relies on garbage collection but at least it works.
    switch (channel) {
        case 0o10:
            last10 = value;
...
const outputFromAGC = (inputBuffer) => {
    let ok = 1;
    ...
    if (ok === 0 && inputBuffer.length > 0) {
        ...
        const channel = ((inputBuffer[0] & 0x0F) << 3) | ((inputBuffer[1] & 0x38) >> 3);
        const value = ((inputBuffer[1] & 0x07) << 12) | ((inputBuffer[2] & 0x3F) << 6) | (inputBuffer[3] & 0x3F);
...
const watchStateYaAGC = (callback) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const handleSocketError = (error) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yaAGCClient.destroy();
        setTimeout(() => (0, exports.watchStateYaAGC)(callback), 2000);
    });
    yaAGCClient.on('close', (hadError) => __awaiter(void 0, void 0, void 0, function* () {
        if (!hadError)
            yield handleSocketError('closed');
    }));
    yaAGCClient.on('error', () => __awaiter(void 0, void 0, void 0, function* () { return yield handleSocketError('connection failed'); }));
    handleAGCUpdate = callback;
});
exports.watchStateYaAGC = watchStateYaAGC;
...
exports.getYaAGCKeyboardHandler = getYaAGCKeyboardHandler;
